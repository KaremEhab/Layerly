...
class _LayoutsAssetsModalState extends State<_LayoutsAssetsModal>
  ...
  Widget _buildDeviceMockupsTab(BuildContext context, EditorState state) {
    final mockups = [
      (
        'iPhone 17 Pro Max',
        '78.0 × 163.4 mm physical ratio with Dynamic Island',
        Icons.phone_iphone_rounded,
        MockupDevice.iphone17ProMax,
        340.0,
        340.0 * (163.4 / 78.0),
      ),
      (
        'iPhone 17 Pro',
        '71.5 × 149.6 mm physical ratio with Dynamic Island',
        Icons.phone_iphone_rounded,
        MockupDevice.iphone17Pro,
        320.0,
        320.0 * (149.6 / 71.5),
      ),
      (
        'iPad Pro 13"',
        '215.5 × 281.6 mm tablet presentation frame',
        Icons.tablet_mac_rounded,
        MockupDevice.ipadPro,
        480.0,
        480.0 * (281.6 / 215.5),
      ),
      (
